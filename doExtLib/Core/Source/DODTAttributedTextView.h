...
@interface DODTAttributedTextView : UIScrollView
{
	// ivars needed by subclasses
	DODTAttributedTextContentView *_attributedTextContentView;
}
 ...
 */
@property (nonatomic, strong, readonly) DODTAttributedTextContentView *attributedTextContentView;
