...
@implementation DODTCoreTextParagraphStyle
{
...
+ (DODTCoreTextParagraphStyle *)defaultParagraphStyle
{
	return [[DODTCoreTextParagraphStyle alloc] init];
}

+ (DODTCoreTextParagraphStyle *)paragraphStyleWithCTParagraphStyle:(CTParagraphStyleRef)ctParagraphStyle
{
	return [[DODTCoreTextParagraphStyle alloc] initWithCTParagraphStyle:ctParagraphStyle];
}

#if DTCORETEXT_SUPPORT_NS_ATTRIBUTES
+ (DODTCoreTextParagraphStyle *)paragraphStyleWithNSParagraphStyle:(NSParagraphStyle *)paragraphStyle
{
	if ( ! paragraphStyle) {
		paragraphStyle = [NSParagraphStyle defaultParagraphStyle];
	}
	
	DODTCoreTextParagraphStyle *retStyle = [[DODTCoreTextParagraphStyle alloc] init];
...
{
	DODTCoreTextParagraphStyle *newObject = [[DODTCoreTextParagraphStyle allocWithZone:zone] init];
...
- (BOOL)isEqual:(id)object
{
	...
	if (![object isKindOfClass:[DODTCoreTextParagraphStyle class]])
	{
		return NO;
	}
	
	DODTCoreTextParagraphStyle *otherStyle = object;
