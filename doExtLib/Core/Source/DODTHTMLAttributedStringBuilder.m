...
#import "DODTTextHTMLElement.h"
#import "DODTBreakHTMLElement.h"
#import "DODTStylesheetHTMLElement.h"
#import "DODTTextAttachmentHTMLElement.h"
#import "DODTLog.h"
...
@interface DODTHTMLAttributedStringBuilder ()
...
@implementation DODTHTMLAttributedStringBuilder
{
    NSData *_data;
    ...
    CGFloat _textScale;
    DODTColor *_defaultLinkColor;
    DODTCSSStylesheet *_globalStyleSheet;
    NSURL *_baseURL;
    DODTCoreTextFontDescriptor *_defaultFontDescriptor;
    DODTCoreTextParagraphStyle *_defaultParagraphStyle;
    
    // root node inherits these defaults
    DODTHTMLElement *_defaultTag;
    ...
    // new parsing
    DODTHTMLElement *_rootNode;
    DODTHTMLElement *_bodyElement;
    DODTHTMLElement *_currentTag;
...
- (BOOL)_buildString
{
    ...
    _globalStyleSheet = [[DODTCSSStylesheet defaultStyleSheet] copy];
    
    // do we have a default style sheet passed as option?
    DODTCSSStylesheet *defaultStylesheet = [_options objectForKey:DTDefaultStyleSheet];
    ...
    _defaultFontDescriptor = [[DODTCoreTextFontDescriptor alloc] initWithFontAttributes:nil];
    ...
    DODTColor *defaultLinkHighlightColor = [_options objectForKey:DTDefaultLinkHighlightColor];
    ...
    _defaultParagraphStyle = [DODTCoreTextParagraphStyle defaultParagraphStyle];
    ...
    _defaultTag = [[DODTHTMLElement alloc] init];
    ...
    if (defaultColor)
    {
        if ([defaultColor isKindOfClass:[DODTColor class]])
        {
            // already a DTColor
    ...
    // create a parser
    DODTHTMLParser *parser = [[DODTHTMLParser alloc] initWithData:_data encoding:encoding];
    ...
    // output metrics
    DTLogInfo((@"DTCoreText created string from %@ HTML in %.2f sec", [NSStr ing stringByFormattingBytes:[_data length]], endTime-startTime);
#endif
...
#pragma mark GCD
              ...
              - (void)_registerTagStartHandlers
              {
                  ...
                  void (^aBlock)(void) = ^
                  {
                      ...
                      _currentTag.anchorId = [_currentTag attributeForKey:@"id"];
                  ...
                  void (^listBlock)(void) = ^
                  {
                      ...
                      DODTCSSListStyle *newListStyle = [_currentTag listStyle];
                  ...
                  void (^fontBlock)(void) = ^
                  {
                      ...
                      if (face)
                      {
                          ...
                          _currentTag.fontDescriptor = [DODTCoreTextFontDescriptor fontDescriptorForCTFont:font];
              ...
              - (void)_registerTagEndHandlers
              {
                  ...
                  {
                      if ([_currentTag isKindOfClass:[DODTTextAttachmentHTMLElement class]])
                      {
                          if ([_currentTag.textAttachment isKindOfClass:[DODTObjectTextAttachment class]])
                          {
                              DODTObjectTextAttachment *objectAttachment = (DODTObjectTextAttachment *)_currentTag.textAttachment;
                  ...
                  void (^videoBlock)(void) = ^
                  {
                      if ([_currentTag isKindOfClass:[DODTTextAttachmentHTMLElement class]])
                      {
                          DODTTextAttachmentHTMLElement *attachmentElement = (DODTTextAttachmentHTMLElement *)_currentTag;
                          
                          if ([attachmentElement.textAttachment isKindOfClass:[DODTVideoTextAttachment class]])
                          {
                              DODTVideoTextAttachment *videoAttachment = (DODTVideoTextAttachment *)attachmentElement.textAttachment;
                              
                              // find first child that has a source
                              if (!videoAttachment.contentURL)
                              {
                                  for (DODTHTMLElement *child in attachmentElement.childNodes)
                                  {
                  ...
                  {
                      DODTCSSStylesheet *localSheet = [(DODTStylesheetHTMLElement *)_currentTag stylesheet];
                  ...
                  void (^linkBlock)(void) = ^
                  {
                      ...
                      if ([type isEqualToString:@"text/css"])
                      {
                          ...
                          if ([stylesheetURL isFileURL])
                          {
                              ...
                              {
                                  DODTCSSStylesheet *localSheet = [[DODTCSSStylesheet alloc] initWithStyleBlock:stylesheetContent];
                                  [_globalStyleSheet mergeStylesheet:localSheet];
                              }
                          }
                          else
...
#pragma mark DTHTMLParser Delegate
              ...
              - (void)parser:(DODTHTMLParser *)parser didStartElement:(NSString *)elementName attributes:(NSDictionary *)attributeDict
              {
                  ...
                  dispatch_group_async(_treeBuildingGroup, _treeBuildingQueue, ^{
                      ...
                      DODTHTMLElement *newNode = [DODTHTMLElement elementWithName:elementName attributes:attributeDict options:_options];
                      DODTHTMLElement *previousLastChild = nil;
                      ...
                      {
                          if ([previousLastChild isKindOfClass:[DODTTextHTMLElement class]])
                          {
                              DODTTextHTMLElement *textElement = (DODTTextHTMLElement *)previousLastChild;
              ...
              - (void)parser:(DODTHTMLParser *)parser didEndElement:(NSString *)elementName
              {
                  dispatch_group_async(_treeBuildingGroup, _treeBuildingQueue, ^{
                      @autoreleasepool {
                          if (_ignoreParseEvents)
                          ...
                          if (_currentTag.displayStyle != DTHTMLElementDisplayStyleNone)
                          {
                              ...
                              {
                                  DODTHTMLElement *theTag = _currentTag;
              ...
              - (void)parser:(DODTHTMLParser *)parser foundCharacters:(NSString *)string
              {
                  dispatch_group_async(_treeBuildingGroup, _treeBuildingQueue, ^{
                      ...
                      if (!_currentTag.preserveNewlines && [string isIgnorableWhitespace])
                      {
                          ...
                          DODTHTMLElement *previousTag = [_currentTag.childNodes lastObject];
                          ...
                          if ([previousTag isKindOfClass:[DODTBreakHTMLElement class]])
                          {
                              return;
                          }
                      }
                      ...
                      DODTTextHTMLElement *textNode = [[DODTTextHTMLElement alloc] init];
              ...
              - (void)parser:(DODTHTMLParser *)parser foundCDATA:(NSData *)CDATABlock
              {
                  dispatch_group_async(_treeBuildingGroup, _treeBuildingQueue, ^{
                      ...
                      // adds a text node to the current node
                      DODTHTMLParserTextNode *textNode = [[DODTHTMLParserTextNode alloc] initWithCharacters:styleBlock];
                      
                      [_currentTag addChildNode:textNode];
                  });
              }
              
              - (void)parserDidEndDocument:(DODTHTMLParser *)parser
              {
                  dispatch_group_async(_treeBuildingGroup, _treeBuildingQueue, ^{
