...
@implementation DODTAttributedTextCell
{
	DODTAttributedTextContentView *_attributedTextContextView;
...
- (DODTAttributedTextContentView *)attributedTextContextView
{
	if (!_attributedTextContextView)
	{
		// don't know size jetzt because there's no string in it
		_attributedTextContextView = [[DODTAttributedTextContentView alloc] initWithFrame:self.contentView.bounds];
