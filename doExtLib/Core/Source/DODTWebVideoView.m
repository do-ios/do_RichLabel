...
@implementation DODTWebVideoView
{
	DODTTextAttachment *_attachment;
	
	DT_WEAK_VARIABLE id <DODTWebVideoViewDelegate> _delegate;
...
- (void)setAttachment:(DODTTextAttachment *)attachment
{
	if (_attachment != attachment)
	{
		...
		if ([attachment isKindOfClass:[DODTIframeTextAttachment class]])
		{
