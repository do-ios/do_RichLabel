...
- (id)initWithHTMLData:(NSData *)data options:(NSDictionary *)options documentAttributes:(NSDictionary * __autoreleasing*)docAttributes
{
	...
	DODTHTMLAttributedStringBuilder *stringBuilder = [[ DODTHTMLAttributedStringBuilder alloc] initWithHTML:data options:options documentAttributes:docAttributes];

	void (^callBackBlock)(DODTHTMLElement *element) = [options objectForKey:DTWillFlushBlockCallBack];
