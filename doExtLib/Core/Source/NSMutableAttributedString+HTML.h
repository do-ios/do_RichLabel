...
@class DODTCoreTextParagraphStyle, DODTCoreTextFontDescriptor;
...
- (void)appendString:(NSString *)string withParagraphStyle:(DODTCoreTextParagraphStyle *)paragraphStyle fontDescriptor:(DODTCoreTextFontDescriptor *)fontDescriptor;
