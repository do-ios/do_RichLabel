...
#import "DODTHTMLParser.h"

@class DODTHTMLElement;

typedef void(^DTHTMLAttributedStringBuilderWillFlushCallback)(DODTHTMLElement *);


/**
 Class for building an `NSAttributedString` from an HTML document.
 */
@interface DODTHTMLAttributedStringBuilder : NSObject <DTHTMLParserDelegate>
