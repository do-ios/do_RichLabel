...
- (BOOL)scanHTMLColor:(DODTColor * __autoreleasing*)color
{
	return [self scanHTMLColor:color HTMLName:NULL];
}

- (BOOL)scanHTMLColor:(DODTColor * __autoreleasing*)color HTMLName:(NSString * __autoreleasing*)name
{
