 ...
 */
@protocol DODTLazyImageViewDelegate <NSObject>
@optional
...
@interface DODTLazyImageView : UIImageView
 ...
 */
@property (nonatomic, DT_WEAK_PROPERTY) id<DODTLazyImageViewDelegate> delegate;
