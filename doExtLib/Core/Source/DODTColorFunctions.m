...
DODTColor *DTColorCreateWithHexString(NSString *hexString)
{
...
#if TARGET_OS_IPHONE
	return [DODTColor colorWithRed:red green:green blue:blue alpha:1.0];
#else
	return (DTColor *)[NSColor colorWithDeviceRed:red green:green blue:blue alpha:1.0];
#endif
}

DODTColor *DTColorCreateWithHTMLName(NSString *name)
{
	if ([name hasPrefix:@"#"])
	{
...
#if TARGET_OS_IPHONE
		return [DODTColor colorWithRed:red green:green blue:blue alpha:alpha];
#else
		return (DODTColor *)[NSColor colorWithDeviceRed:red green:green blue:blue alpha:alpha];
#endif
	}
...
NSString *DTHexStringFromDTColor(DODTColor *color)
{
