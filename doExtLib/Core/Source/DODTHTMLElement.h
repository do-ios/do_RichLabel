...
@class DODTCoreTextParagraphStyle;
@class DODTCoreTextFontDescriptor;
@class DODTTextAttachment;
@class DODTCSSListStyle;
 ...
 */
@interface DODTHTMLElement : DODTHTMLParserNode
{
	DODTCoreTextFontDescriptor *_fontDescriptor;
	DODTCoreTextParagraphStyle *_paragraphStyle;
	DODTTextAttachment *_textAttachment;
	DTTextAttachmentVerticalAlignment _textAttachmentAlignment;
	NSURL *_link;
	NSString *_anchorName;
	
	DODTColor *_textColor;
	DODTColor *_backgroundColor;
	
	DODTColor *_backgroundStrokeColor;
 ...
 */
+ (DODTHTMLElement *)elementWithName:(NSString *)name attributes:(NSDictionary *)attributes options:(NSDictionary *)options;
 ...
 */
@property (nonatomic, copy) DODTCoreTextFontDescriptor *fontDescriptor;

/**
 Paragraph Style describing the paragraph state of the receiver
 */
@property (nonatomic, copy) DODTCoreTextParagraphStyle *paragraphStyle;

/**
 Text Attachment of the receiver, or `nil` if there is no attachment
 */
@property (nonatomic, strong) DODTTextAttachment *textAttachment;
...
/**
 Anchor id,of the receiver that can be used to scroll to.
 */
 ...
 */
@property (nonatomic, strong) DODTColor *textColor;

/**
 Background color of text in the receiver
 */
@property (nonatomic, strong) DODTColor *backgroundColor;

/**
 Background stroke color in the receiver
 */
@property (nonatomic, strong) DODTColor *backgroundStrokeColor;
