...
@interface DODTAccessibilityViewProxy : NSProxy
/**
 The delegate for the proxy
 */
@property (nonatomic, weak, readonly) id<DTAccessibilityViewProxyDelegate> delegate;

/**
 The text attachment represented by the proxy
 */
@property (nonatomic, strong, readonly) DODTTextAttachment *textAttachment;
...
- (UIView *)viewForTextAttachment:(DODTTextAttachment *)attachment proxy:(DODTAccessibilityViewProxy *)proxy;
@end