...
@class DODTCoreTextLayoutLine;
@class DODTTextBlock;


typedef void (^DTCoreTextLayoutFrameTextBlockHandler)(DODTTextBlock *textBlock, CGRect frame, CGContextRef context, BOOL *shouldDrawDefaultBackground);
 ...
 */
@interface DODTCoreTextLayoutFrame : NSObject
{
	CGRect _frame;
...
/**
 ...
 @returns The correct baseline origin for the line.
 */
- (CGPoint)baselineOriginToPositionLine:(DODTCoreTextLayoutLine *)line afterLine:(DODTCoreTextLayoutLine *)previousLine __attribute__((deprecated("use use -[baselineOriginToPositionLine:afterLine:algorithm:] instead")));;
