...
@class DODTWebVideoView;
@class DODTTextAttachment;

/**
 Protocol for delegates of <DTWebVideoView>
*/
@protocol DODTWebVideoViewDelegate <NSObject>
...
- (BOOL)videoView:(DODTWebVideoView *)videoView shouldOpenExternalURL:(NSURL *)url;
 ...
 */
@interface DODTWebVideoView : UIView <UIWebViewDelegate>

/**
 The delegate of the video view
 */
@property (nonatomic, DT_WEAK_PROPERTY) id <DODTWebVideoViewDelegate> delegate;

/**
 The text attachment representing an embedded video.
 */
@property (nonatomic, strong) DODTTextAttachment *attachment;
