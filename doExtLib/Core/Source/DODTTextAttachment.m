...
#import "DODTCoreGraphicsUtils.h"
...
@interface DODTTextAttachment ()

@end

@implementation DODTTextAttachment
{
	NSURL *_hyperLinkURL;
...
+ (void)initialize
{
	...
	if (self != [DODTTextAttachment class])
	{
		return;
	}
	...
	[DODTTextAttachment registerClass:[DODTImageTextAttachment class] forTagName:@"img"];
	[DODTTextAttachment registerClass:[DODTVideoTextAttachment class] forTagName:@"video"];
	[DODTTextAttachment registerClass:[DODTIframeTextAttachment class] forTagName:@"iframe"];
	[DODTTextAttachment registerClass:[DODTObjectTextAttachment class] forTagName:@"object"];
}

+ (DODTTextAttachment *)textAttachmentWithElement:(DODTHTMLElement *)element options:(NSDictionary *)options
{
	Class class = [DODTTextAttachment registeredClassForTagName:element.name];
	...
	DODTTextAttachment *attachment = [class alloc];
...
{
	Class previousClass = [DODTTextAttachment registeredClassForTagName:tagName];
