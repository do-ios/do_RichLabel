...
@class DODTAttributedTextContentView;
@class DODTCoreTextLayoutFrame;
@class DODTTextBlock;
@class DODTCoreTextLayouter;
 ...
 */
- (void)attributedTextContentView:(DODTAttributedTextContentView *)attributedTextContentView willDrawLayoutFrame:(DODTCoreTextLayoutFrame *)layoutFrame inContext:(CGContextRef)context;
 ...
 */
- (void)attributedTextContentView:(DODTAttributedTextContentView *)attributedTextContentView didDrawLayoutFrame:(DODTCoreTextLayoutFrame *)layoutFrame inContext:(CGContextRef)context;
 ...
 */
- (UIView *)attributedTextContentView:(DODTAttributedTextContentView *)attributedTextContentView viewForLink:(NSURL *)url identifier:(NSString *)identifier frame:(CGRect)frame;
...
@interface DODTAttributedTextContentView : UIView
{
	NSAttributedString *_attributedString;
	DODTCoreTextLayoutFrame *_layoutFrame;
 ...
 */
@property (atomic, strong) DODTCoreTextLayouter *layouter;
 ...
 */
@property (atomic, strong) DODTCoreTextLayoutFrame *layoutFrame;
 ...
 */
@interface DODTAttributedTextContentView (Tiling)
 ...
 */
@interface DODTAttributedTextContentView (Drawing)
 ...
 */
@interface DODTAttributedTextContentView (Cursor)
