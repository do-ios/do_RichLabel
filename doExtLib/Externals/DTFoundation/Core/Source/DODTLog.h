...
typedef void (^DODTLogBlock)(NSUInteger logLevel, NSString *fileName, NSUInteger lineNumber, NSString *methodName, NSString *format, ...);


// internal variables needed by macros
extern DODTLogBlock DTLogHandler;
 ...
 */
void DTLogSetLoggerBlock(DODTLogBlock handler);
