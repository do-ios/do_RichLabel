...
#import "DODTFolderMonitor.h"

@implementation DODTFolderMonitor
{
	NSURL *_URL;
...
+ (DODTFolderMonitor *)folderMonitorForURL:(NSURL *)URL block:(DTFolderMonitorBlock)block
{
	return [[DODTFolderMonitor alloc] initWithURL:URL block:block];
}
