...
#import "DODTPieProgressIndicator.h"
#import "DODTCoreGraphicsUtils.h"

#define PIE_SIZE CGFloat_(34)

@implementation DODTPieProgressIndicator
{
...
{
	return [[DODTPieProgressIndicator alloc] initWithFrame:CGRectMake(0, 0, PIE_SIZE, PIE_SIZE)];
}
