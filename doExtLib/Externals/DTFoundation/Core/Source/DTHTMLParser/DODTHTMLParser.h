 ...
 */
- (void)parserDidStartDocument:(DODTHTMLParser *)parser;
 ...
 */
- (void)parser:(DODTHTMLParser *)parser foundComment:(NSString *)comment;
 ...
 */
- (void)parser:(DODTHTMLParser *)parser foundProcessingInstructionWithTarget:(NSString *)target data:(NSString *)data;
 ...
 */
- (void)parser:(DODTHTMLParser *)parser parseErrorOccurred:(NSError *)parseError;
 ...
 */
@interface DODTHTMLParser : NSObject
