...
@class DODTASN1Parser, DODTASN1BitString;
 ...
 */
- (void)parserDidStartDocument:(DODTASN1Parser *)parser;
...
/**
 ...
 @param parser A parser object.
 */
- (void)parserDidEndDocument:(DODTASN1Parser *)parser;
 ...
 */
- (void)parser:(DODTASN1Parser *)parser didStartContextWithTag:(NSUInteger)tag;
 ...
 */
- (void)parser:(DODTASN1Parser *)parser didEndContextWithTag:(NSUInteger)tag;
 ...
 */
- (void)parser:(DODTASN1Parser *)parser parseErrorOccurred:(NSError *)parseError;
 ...
 */
@interface DODTASN1Parser : NSObject
